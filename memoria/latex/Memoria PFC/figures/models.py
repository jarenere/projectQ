...
class Question(db.Model):
    ...
    subquestions = relationship("Condition", foreign_keys="Condition.subquestion_id", \
        backref=backref("parent", uselist = True))

    parent = relationship("Condition", foreign_keys="Condition.parent_id",\
       backref=backref("subquestion", uselist=False))
    ...
    # subquestion = relationship("Condition",
    #     cascade="all, delete-orphan",
    #     backref=backref("subquestion", uselist=False),
    #     single_parent=True)
    
    # parent = relationship("Condition",
...
class Condition(db.Model):
    ...
    subquestion_id = Column(Integer, ForeignKey('question.id'))
