##Información
Esta web es solo una muestra de la plataforma que esta en desarrollo y puede no contener la última versión de desarrollo, además la base de datos puede ser eliminada en cualquier momento. Además seguramente la web este llena de bugs y cosas feas, no os asustéis.
